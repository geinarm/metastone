...
import net.demilich.metastone.game.behaviour.aiplanner.AlphaBetaPerfect;
import net.demilich.metastone.game.behaviour.aiplanner.TurnPlanner;
...
public class PlayerConfigView extends VBox {
	...
	public void setupBehaviours() {
		...
		behaviourList.add(new AlphaBetaPerfect());
		behaviourList.add(new TurnPlanner());
